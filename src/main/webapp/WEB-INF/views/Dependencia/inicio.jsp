       	...
       	<!-- inicio del segemento de codigo  -->
	      	<table >
                <tr>
                    ...
                    <td class="td-dep">
                    <img id="opc_dependencia" src="<c:url value="/images/Dependencia/Dependencia.svg"/>" onclick="javascript:window.location.href = '<c:url value="/Dependencia/Registro"/>'">
                    </td>
       			</tr>
       			<tr>
           			<td class="td-dep">
                    <img id="opc_contacto"  src="<c:url value="/images/Dependencia/_Contacto.svg"/>" onclick="javascript:window.location.href = '<c:url value="/Dependencia/Contacto"/>'">
                    </td>
				</tr>
          </table>  
