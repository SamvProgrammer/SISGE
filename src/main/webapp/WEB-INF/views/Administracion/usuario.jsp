...
<html lang="es">
    <head>
        ...
        <link href="<c:url value="/css/Administracion/inicio.css"/>" rel="stylesheet" type="text/css"/>
         <script src="<c:url value="/js/Administracion/usuario.js"/>" charset="UTF-8" type="text/javascript"></script>
    ...
    <body>
        ...
        <div id="regresa" class="back">
       	...
       	<div class="form-group">
	       	 ...
	       	 <div class="col-sm-2">
	       			...
	       			<input type="text"  id="txt_usuario" name="txt_usuario" class="txts_letras form-control" maxlength="10" placeholder="Usuario"  />
	       	</div>
       	...
       	<div class="form-group">
	       	 ...
	       	 <div class="col-sm-2">
	       		...
	       		<input type="text"  id="txt_pass" name="txt_pass" class="txts_letras form-control" maxlength="10" placeholder="Contraseña"  />
       	 ...
       	 <div class="form-group">
       		...
       		<button id="btn_enviar_usuario" class="btn btn-success" >Enviar</button>
     ...
     <table id="table_usuario" class="table table-striped table-inverse bg-success text-center">
