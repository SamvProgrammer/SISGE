...
<html lang="es">
    <head>
        ...
        <script src="<c:url value="/js/Administracion/catalogos/Motivo.js"/>" charset="UTF-8" type="text/javascript"></script>
    ...
    <body>
        ...
        <form id="form_motivo"  class="form-horizontal">
       	
		       	<h4 class="title">Registro del Motivo del contacto </h4>
		       	
		       	<div class="form-group">
			       	 
			       	 <div class="col-sm-2">
			    
			       			<input type="text"  id="txt_motivo" name="txt_motivo" class="txts_letras form-control" maxlength="250" placeholder="Motivo"  />
			       	</div>
		       	 ...
		       	 <div class="form-group">
		       		...
		       		<button id="btn_enviar_motivo" class="btn btn-success button_enviar" >Enviar</button>
		       	 
		       	  </div>
       	
       	</form>
       	<!-- INICIO DE LA SECCION DE TABLAS  -->
       	<div id="div_tabla_motivo">
		     <table id="table_motivo" class="table table-striped table-inverse bg-success text-center">
