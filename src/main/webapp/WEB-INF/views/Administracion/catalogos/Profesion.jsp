...
<html lang="es">
    <head>
        ...
        <script src="<c:url value="/js/Administracion/catalogos/Profesion.js"/>" charset="UTF-8" type="text/javascript"></script>
    ...
    <body>
        ...
        <form id="form_profesion"  class="form-horizontal">
       	
		       	<h4 class="title">Registro de Profesión </h4>
		       	
		       	<div class="form-group">
			       	 
			       	 <div class="col-sm-2">
			    
			       			<input type="text"  id="txt_profesion" name="txt_profesion" class="txts_letras form-control" maxlength="50" placeholder="Profesión"  />
			       	</div>
		       ...
		       <div class="form-group">
			       	 ...
			       	 <div class="col-sm-2">
			       			...
			       			<input type="text"  id="txt_abreviatura" name="txt_abreviatura" class="txts_letras form-control" maxlength="10" placeholder="Abreviatura"  />
			       	</div>
		       	 ...
		       	 <div class="form-group">
		       		...
		       		<button id="btn_enviar_profesion" class="btn btn-success button_enviar" >Enviar</button>
		       	 
		       	  </div>
       	
       	</form>
       	<!-- INICIO DE LA SECCION DE TABLAS  -->
       	<div id="div_tabla_profesion">
		     <table id="table_profesion" class="table table-striped table-inverse bg-success text-center">
