...
<html lang="es">
    <head>
        ...
        <script src="<c:url value="/js/Administracion/catalogos/Estado.js"/>" charset="UTF-8" type="text/javascript"></script>
    ...
    <body>
        ...
        <form id="form_estado"  class="form-horizontal">
		       	...
		       	<h4 class="title">Registro del Estado </h4>
		       	
		       	<div class="form-group">
			       	 
			       	 <div class="col-sm-2">
			    
			       			<input type="text"  id="txt_nombre_estado" name="txt_nombre_estado" class="txts_letras form-control" maxlength="50" placeholder="Estado"  />
			       	</div>
		        ...
		        <div class="form-group">
		       	...
		       	<div class="form-group">
		       	 ...
		       	 <div class="form-group">
		       		...
		       		<button id="btn_enviar_estado" class="btn btn-success button_enviar" >Enviar</button>
		       	 
		       	  </div>
       	
       	</form>
       	<!-- INICIO DE LA SECCION DE TABLAS  -->
       	<div id="div_tabla_estado">
		     <table id="table_estado" class="table table-striped table-inverse bg-success text-center">
